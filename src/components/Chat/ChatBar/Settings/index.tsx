...
export function Settings() {
  ...
  const [backgroundColor, setBackgroundColor] = useState(() => localStorage.getItem('backgroundColor') || '#121212');
  const [contrastColor, setContrastColor] = useState(() => localStorage.getItem('contrastColor') || '#242424');
